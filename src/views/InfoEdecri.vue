<template>
    <div class="content">
        ...
        <h4>
            ...
            <a href="https://www.facebook.com/profile.php?id=100068380068173" target="_blank" rel="noopener"
                >Mas información</a
            >.
        </h4>
        <h4>MISIÓN</h4>
        <ul>
            <li>
                <center>
                    <I>
                        <p>
                            Mejorar la calidad de vida de las personas no importando el estatus social,
                            <br />
        ...
        <ul>
            <li>
                <center>
                    <I>
                        <p>
                            Ser una Fundación moderna, segura, accesible para todos los Guatemaltecos <br />
